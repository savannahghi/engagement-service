...
MESSAGE_A = {
    "message": (
        ...
        "For more information, call 0790 360 360. Be.Well by Slade 360."
    ),
...
MESSAGE_B = {
    "message": (
        ...
        "and {} claim history on the new Be.Well app. Download it "
        "at {}. To opt out, dial *384*600#. For more information, call "
        "0790 360 360. Be.Well by Slade 360."
    ),

...
//PhoneNumberVerificationCode mock function
...
//WellnessCardActivationDependant mock function
func (f *FakeServiceWhatsapp) WellnessCardActivationDependant(ctx context.Context, to string, memberName string, cardName string, marketingMessage string) (bool, error) {
	return f.WellnessCardActivationDependantFn(ctx, to, memberName, cardName, marketingMessage)
}

//WellnessCardActivationPrincipal mock function
func (f *FakeServiceWhatsapp) WellnessCardActivationPrincipal(ctx context.Context, to string, memberName string, cardName string, minorAgeThreshold string, marketingMessage string) (bool, error) {
	return f.WellnessCardActivationPrincipalFn(ctx, to, memberName, cardName, minorAgeThreshold, marketingMessage)
}

//BillNotification mock function
func (f *FakeServiceWhatsapp) BillNotification(ctx context.Context, to string, productName string, billingPeriod string, billAmount string, paymentInstruction string, marketingMessage string) (bool, error) {
	return f.BillNotificationFn(ctx, to, productName, billingPeriod, billAmount, paymentInstruction, marketingMessage)
}

//VirtualCards mock function
...
func (f *FakeServiceWhatsapp) VisitStart(ctx context.Context, to string, memberName string, benefitName string, locationName string, startTime string, balance string, marketingMessage string) (bool, error) {
	return f.VisitStartFn(ctx, to, memberName, benefitName, locationName, startTime, balance, marketingMessage)
}

//ClaimNotification mock function
func (f *FakeServiceWhatsapp) ClaimNotification(ctx context.Context, to string, claimReference string, claimTypeParenthesized string, provider string, visitType string, claimTime string, marketingMessage string) (bool, error) {
	return f.ClaimNotificationFn(ctx, to, claimReference, claimTypeParenthesized, provider, visitType, claimTime, marketingMessage)
}

// PreauthApproval mock function
func (f *FakeServiceWhatsapp) PreauthApproval(ctx context.Context, to string, currency string, amount string, benefit string, provider string, member string, careContact string, marketingMessage string) (bool, error) {
	return f.PreauthApprovalFn(ctx, to, currency, amount, benefit, provider, member, careContact, marketingMessage)
}

//PreauthRequest mock function
func (f *FakeServiceWhatsapp) PreauthRequest(ctx context.Context, to string, currency string, amount string, benefit string, provider string, requestTime string, member string, careContact string, marketingMessage string) (bool, error) {
	return f.PreauthRequestFn(ctx, to, currency, amount, benefit, provider, requestTime, member, careContact, marketingMessage)
}

//SladeOTP mock function
...
//SaveTwilioCallbackResponse mock function

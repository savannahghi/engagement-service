...
func ultimateComposite(
	...
	links := []base.Link{
		base.GetPNGImageLink(
			common.StaticBase+"/items/images/bewell_banner01.png",
			"As within, so without",
			"As within, so without. Care begins with the self.",
			common.StaticBase+"/items/images/thumbs/bewell_banner01.png",
		),
		base.GetPNGImageLink(
			common.StaticBase+"/items/images/bewell_banner02.png",
			"Have you made your bed today?",
			"Have you made your bed today? Your morning routine can get you started on a high note or not.",
			common.StaticBase+"/items/images/thumbs/bewell_banner02.png",
		),
		base.GetPNGImageLink(
			common.StaticBase+"/items/images/bewell_banner03.png",
			"Smiles are contagious",
			"Smiles are contagious, pass it on and heal a heart",
			common.StaticBase+"/items/images/thumbs/bewell_banner03.png",
		),
		base.GetPNGImageLink(
			common.StaticBase+"/items/images/bewell_banner04.png",
			"Tossing and turning?",
			"Too much screen time tampers with sleep",
			common.StaticBase+"/items/images/thumbs/bewell_banner04.png",
		),
		base.GetPNGImageLink(
			common.StaticBase+"/items/images/bewell_banner05.png",
			"Wellness review",
			"You should have a wellness review daily",
			common.StaticBase+"/items/images/thumbs/bewell_banner05.png",
		),
		base.GetPNGImageLink(
			common.StaticBase+"/items/images/bewell_banner06.png",
			"Wellness review",
			"You should have a wellness review daily",
			common.StaticBase+"/items/images/thumbs/bewell_banner06.png",
		),
		base.GetPNGImageLink(
			common.StaticBase+"/items/images/bewell_banner07.png",
			"Healthcare Simplified",
			"HealthCare Simplified. Get Be.Well",
			common.StaticBase+"/items/images/thumbs/bewell_banner07.png",
		),
		base.GetPNGImageLink(
			common.StaticBase+"/items/images/bewell_banner08.png",
			"Hot + Hot",
			"Did you know that Hot + Hot=Cool?",
			common.StaticBase+"/items/images/thumbs/bewell_banner08.png",
		),
		base.GetPNGImageLink(
			common.StaticBase+"/items/images/bewell_banner09.png",
			"Does chewing gum improve focus?",
			"Does chewing gum improve focus? Yes or No. Tell us in the comments section.",
			common.StaticBase+"/items/images/thumbs/bewell_banner09.png",
		),
		base.GetPNGImageLink(
			common.StaticBase+"/items/images/bewell_banner10.png",
			"Are you well?",
			"We take care of you with convenient teleconsultation.",
			common.StaticBase+"/items/images/thumbs/bewell_banner10.png",
		),
		base.GetPNGImageLink(
			common.StaticBase+"/items/images/bewell_banner11.png",
			"Hands that heal",
			"Get Be.Well",
			common.StaticBase+"/items/images/thumbs/bewell_banner11.png",
		),
		base.GetPNGImageLink(
			common.StaticBase+"/items/images/bewell_banner12.png",
			"Mindfulness matters",
			"Use Be.Well to consult",
			common.StaticBase+"/items/images/thumbs/bewell_banner12.png",
		),
		base.GetPNGImageLink(
			common.StaticBase+"/items/images/bewell_banner13.png",
			"Be confident",
			"Be confident, you can consult in confidence. Use Be.Well.",
			common.StaticBase+"/items/images/thumbs/bewell_banner13.png",
		),
		base.GetPNGImageLink(
			common.StaticBase+"/items/images/bewell_banner14.png",
			"Wellnes begins in the womb",
			"Wellness begins in the womb, we are here to walk with you",
			common.StaticBase+"/items/images/thumbs/bewell_banner14.png",
		),
		base.GetPNGImageLink(
			common.StaticBase+"/items/images/bewell_banner15.png",
			"Self healing is...",
			"Self healing is...what techniques do you use to slow down and rejuvenate",
			common.StaticBase+"/items/images/thumbs/bewell_banner15.png",
		),
		base.GetPNGImageLink(
			common.StaticBase+"/items/images/bewell_banner16.png",
			"Live. Love. Laugh. and Be.Well",
			"Live. Love. Laugh and Be.Well. Download Be.Well",
			common.StaticBase+"/items/images/thumbs/bewell_banner16.png",
		),
		base.GetPNGImageLink(
			common.StaticBase+"/items/images/bewell_banner17.png",
			"Mindfulness matters",
			"Mindfulness matters. Use Be.Well to consult",
			common.StaticBase+"/items/images/thumbs/bewell_banner17.png",
		),
		base.GetPNGImageLink(
			common.StaticBase+"/items/images/bewell_banner18.png",
			"Be.Well can transform you",
			"Be.Well can transform you. Get Be.Well",
			common.StaticBase+"/items/images/thumbs/bewell_banner18.png",
		),
		base.GetPNGImageLink(
			common.StaticBase+"/items/images/bewell_banner19.png",
			"Need to refill your meds?",
			"Need to refill your meds? We will deliver",
			common.StaticBase+"/items/images/thumbs/tbewell_banner19.png",
		),
		base.GetPNGImageLink(
			common.StaticBase+"/items/images/bewell_banner20.png",
			"Be optimistic, live longer",
			"Use Be.Well to help you manage ailments",
			common.StaticBase+"/items/images/thumbs/bewell_banner20.png",
		),
		base.GetPNGImageLink(
			common.StaticBase+"/items/images/bewell_banner21.png",
			"Are you too anxious?",
			"Are you too anxious? Consult on Be.Well",
			common.StaticBase+"/items/images/thumbs/bewell_banner21.png",
		),
		base.GetPNGImageLink(
			common.StaticBase+"/items/images/bewell_banner22.png",
			"Would you rather be taking tablets or syrup?",
			"Share your reasons in the comments section",
			common.StaticBase+"/items/images/thumbs/bewell_banner22.png",
		),
		base.GetPNGImageLink(
			common.StaticBase+"/items/images/bewell_banner23.png",
			"Does coffee cure depression in women?",
			"How does coffee affect you?",
			common.StaticBase+"/items/images/thumbs/bewell_banner23.png",
		),
		base.GetPNGImageLink(
			common.StaticBase+"/items/images/bewell_banner24.png",
			"Is your allergy triggered by stress?",
			"Get Be.Well for more insights",
			common.StaticBase+"/items/images/thumbs/bewell_banner24.png",
		),

		base.GetPDFDocumentLink(
			common.StaticBase+"/items/documents/bewell_banner_25.pdf",
			"Does sunlight enable weight loss?",
			"Get Be.Well for meaningful insights",
			common.StaticBase+"/items/documents/thumbs/bewell_banner_25.png",
		),
		base.GetPDFDocumentLink(
			common.StaticBase+"/items/documents/bewell_banner_26.pdf",
			"Anti-depressants and your libido.",
			"Consult your doctor on Be.Well",
			common.StaticBase+"/items/documents/thumbs/bewell_banner_26.png",
		),
		base.GetPDFDocumentLink(
			common.StaticBase+"/items/documents/bewell_banner_27.pdf",
			"Need to refill your meds?",
			"We will deliver",
			common.StaticBase+"/items/documents/thumbs/bewell_banner_27.png",
		),
		base.GetPDFDocumentLink(
			common.StaticBase+"/items/documents/bewell_banner_28.pdf",
			"Sexual wellness tips.",
			"Get Be.Well for the best tips",
			common.StaticBase+"/items/documents/thumbs/bewell_banner_28.png",
		),
		base.GetPDFDocumentLink(
			common.StaticBase+"/items/documents/bewell_banner_29.pdf",
			"How do you get your kids to take meds?",
			"Do you negotiate or introduce Kiboko the motivator?",
			common.StaticBase+"/items/documents/thumbs/bewell_banner_29.png",
		),
		base.GetPDFDocumentLink(
			common.StaticBase+"/items/documents/bewell_banner_30.pdf",
			"What are some of the meds that were part of you growing up?",
			"Get Be.Well",
			common.StaticBase+"/items/documents/thumbs/bewell_banner_30.png",
		),
		base.GetPDFDocumentLink(
			common.StaticBase+"/items/documents/bewell_banner_31.pdf",
			"Mind your Mind",
			"Use Be.Well",
			common.StaticBase+"/items/documents/thumbs/bewell_banner_31.png",
		),
		base.GetPDFDocumentLink(
			common.StaticBase+"/items/documents/bewell_banner_32.pdf",
			"Did you know that financial wellness affects your wellbeing as a whole?",
			"What else? Get Be.Well",
			common.StaticBase+"/items/documents/thumbs/bewell_banner_32.png",
		),
		base.GetPDFDocumentLink(
			common.StaticBase+"/items/documents/bewell_banner_33.pdf",
			"How does technology preserve your health?",
			"Get Be.Well for meaningful insights",
			common.StaticBase+"/items/documents/thumbs/bewell_banner_33.png",
		),
		base.GetPDFDocumentLink(
			common.StaticBase+"/items/documents/bewell_banner_34.pdf",
			"Your life can be transformed by an App",
			"Get Be.Well",
			common.StaticBase+"/items/documents/thumbs/bewell_banner_34.png",
		),
		base.GetPDFDocumentLink(
			common.StaticBase+"/items/documents/bewell_banner_35.pdf",
			"It's not enough to just have a life transforming App",
			"You have to USE the App",
			common.StaticBase+"/items/documents/thumbs/bewell_banner_35.png",
		),
		base.GetPDFDocumentLink(
			common.StaticBase+"/items/documents/bewell_banner_36.pdf",
			"Create your wellness habits",
			"Create your wellness habits and add your accountability partners on Be.Well",
			common.StaticBase+"/items/documents/thumbs/bewell_banner_36.png",
		),
		base.GetPDFDocumentLink(
			common.StaticBase+"/items/documents/bewell_banner_37.pdf",
			"Patients don't need patience",
			"Dial your doctor, Now!",
			common.StaticBase+"/items/documents/thumbs/bewell_banner_37.png",
		),
		base.GetPDFDocumentLink(
			common.StaticBase+"/items/documents/bewell_banner_38.pdf",
			"Simplifying and streamlining Healthcare",
			"Get Be.Well today!",
			common.StaticBase+"/items/documents/thumbs/bewell_banner_38.png",
		),
		base.GetPDFDocumentLink(
			common.StaticBase+"/items/documents/bewell_banner_39.pdf",
			"Monitor your mental state",
			"Get Be.Well today!",
			common.StaticBase+"/items/documents/thumbs/bewell_banner_39.png",
		),
		base.GetPDFDocumentLink(
			common.StaticBase+"/items/documents/bewell_banner_40.pdf",
			"Modern Medicine vs Mystic Medicine",
			"Modern Medicine vs Mystic Medicine. What works for you?",
			common.StaticBase+"/items/documents/thumbs/bewell_banner_40.png",
		),
		base.GetPDFDocumentLink(
			common.StaticBase+"/items/documents/bewell_banner_41.pdf",
			"To Be.Well, your finances have to be well",
			"To Be.Well, your finances have to be well",
			common.StaticBase+"/items/documents/thumbs/bewell_banner_41.png",
		),
		base.GetPDFDocumentLink(
			common.StaticBase+"/items/documents/bewell_banner_42.pdf",
			"Finance and Romance",
			"do they go hand in hand?",
			common.StaticBase+"/items/documents/thumbs/bewell_banner_42.png",
		),
		base.GetPDFDocumentLink(
			common.StaticBase+"/items/documents/bewell_banner_43.pdf",
			"Let's talk about sex",
			"Let's talk about sex, the Be.Well way",
			common.StaticBase+"/items/documents/thumbs/bewell_banner_43.png",
		),
		base.GetPDFDocumentLink(
			common.StaticBase+"/items/documents/bewell_banner_44.pdf",
			"Consult about sexual health in confidence",
			"Consult about sexual health in confidence",
			common.StaticBase+"/items/documents/thumbs/bewell_banner_44.png",
		),
		base.GetPDFDocumentLink(
			common.StaticBase+"/items/documents/bewell_banner_45.pdf",
			"Is technology replacing your parenting?",
			"Is technology replacing your parenting?",
			common.StaticBase+"/items/documents/thumbs/bewell_banner_45.png",
		),
		base.GetPDFDocumentLink(
			common.StaticBase+"/items/documents/bewell_banner_46.pdf",
			"Bottled water cures diseases",
			"Bottled water cures diseases. True or False?",
			common.StaticBase+"/items/documents/thumbs/bewell_banner_46.png",
		),
		base.GetPDFDocumentLink(
			common.StaticBase+"/items/documents/bewell_banner_47.pdf",
			"Why fight for these gadgets?",
			"Why fight for these gadgets? Could it be a symptom or addiction?",
			common.StaticBase+"/items/documents/thumbs/bewell_banner_47.png",
		),
		base.GetPDFDocumentLink(
			common.StaticBase+"/items/documents/bewell_banner_48.pdf",
			"Put your money where your mind is",
			"Put your money where your mind is",
			common.StaticBase+"/items/documents/thumbs/bewell_banner_48.png",
		),
	}
	actions, err := defaultActions(ctx, uid, flavour, repository)
	if err != nil {
